...
@autoinject
@observable({ name: 'book.description', changeHandler: 'bookDescriptionChanged' })
export class BookView {
  ...
  bookDescriptionChanged(n, o) {
    console.log(`book description changed: ${n}`)
  }
